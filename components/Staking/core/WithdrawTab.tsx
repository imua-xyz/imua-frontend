...
export function WithdrawTab({
  ...
  const maxWithdrawAmount =
    stakingProvider.stakerBalance?.withdrawable || BigInt(0);
  ...
  return (
    <div className="space-y-4">
      ...
      {canClaimPrincipal && (
        <>
          <div>
            ...
            />
            {claimAmountError && (
              <p className="text-sm text-red-600 mt-1">{claimAmountError}</p>
            )}
          </div>
          <Button
            className="w-full"
            ...
            onClick={() =>
              handleOperation(() =>
                stakingProvider.claimPrincipal!(parsedClaimAmount, {
      ...
      <div className="space-y-2">
        ...
        />
        {withdrawAmountError && (
          <p className="text-sm text-red-600 mt-1">{withdrawAmountError}</p>
        )}
        <Input

...
export const XRP_TOKEN_ADDRESS = '0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB' as `0x${string}`;
...
export const XRP_VAULT_ADDRESS = process.env.XRP_VAULT_ADDRESS || '';

// UI Configuration
export const XRP_TESTNET_EXPLORER_URL = process.env.XRP_TESTNET_EXPLORER_URL || '';
export const XRP_MAINNET_EXPLORER_URL = process.env.XRP_MAINNET_EXPLORER_URL || '';

export const MIN_STAKE_AMOUNT = process.env.MIN_STAKE_AMOUNT || '';
export const DEFAULT_LEDGER_WAIT_TIME = process.env.DEFAULT_LEDGER_WAIT_TIME || '';
export const MAX_TRANSACTION_ATTEMPTS = process.env.MAX_TRANSACTION_ATTEMPTS || '';
...
export const XRPL_EXPLORER = {
  transaction: (hash: string) => `https://livenet.xrpl.org/transactions/${hash}`,
